    ...
    <div className="img-container">
      ...
      <div className="about-content ">
        <p className="about-text">
          ...
          I am currently enrolled in the University of Toronto coding boot camp. Upon completion I will be looking to make a full time career change out of the hospitality industry. The hospitality industry has taught me everything you need to know about customer service, how to keep a customer happy and truly understand what a customer is looking for even when they are not clear on what they want. This is a valuable asset I will bring to the table as a web developer.
        </p>
        <p className="about-text">
        I currently reside in Burlington Ontario with my Fiancé and three kids. From March 2020 until my enrolment at the University of Toronto coding boot camp in November I have been self learning web development. Through the course I have learned HTML, CSS, JavaScript, jQuery, Bootstrap, Node.js, Express.js, AJAX, SQL, MongoDB, OOP/TDD, ORM/MVC, PWA and React.
        </p>
        <p className="about-text">
